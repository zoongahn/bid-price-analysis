...
function CompaniesPage() {
	...
	const fetchData = async () => {
		try {
			...
			const url = "http://127.0.0.1:8000/api/companies/?page=1&page_size=10000"
	...
	return (
		<div className="app-container">
			...
			<div className="main-content">
				<h1 className="page-title">기업 데이터 조회</h1>
				<MyAgGridTable columns={COMPANY_COLUMNS} tableData={tableData} />
			</div>
		</div>
	)
}
