...
RESULT_FILE_PATH = f"{OUTPUT_FILE_PATH}/original/공고기본정보_{year}_서울_통신_original.csv"
...
result["기초금액"] = price_converter(bid_infos[6].text)
result["예정가격"] = price_converter(bid_infos[8].text)
...
if "A값" in bid_marks:
	result["A값"] = price_converter(bid_infos[10].text)
