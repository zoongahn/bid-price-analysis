...
class Notice(models.Model):
	...
	투찰률 = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
	참여업체수 = models.IntegerField()
	공고구분표시 = models.CharField(max_length=100, null=True, blank=True)
	정답사정률 = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
...
class Bid(models.Model):
	...
	가격점수 = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
	예가대비투찰률 = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
	기초대비투찰률 = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
	기초대비사정률 = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
